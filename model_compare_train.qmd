...
```{python}
#| label: tbl-missing
#| tbl-cap: "Summary of missing data"

missing_glimpse = pd.DataFrame({
...
categorical_high_cardinality = ['WaitListOpName', 'OPCSCategory'] 
numerical_features = ['PatientAge', 'PatientBMI', 'HeartRateMonitored'] 
#'DaysAgo' 'DiastolicBloodPressure' 'SystolicBloodPressure' 
binary_features = ['Injection','Amputation', 'Replacement','Repair','Toe','Hip','Knee']
```
...
y = data['CaseDuration']
X = data[numerical_features + categorical_low_cardinality + categorical_high_cardinality + binary_features]
